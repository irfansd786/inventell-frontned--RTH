// Dense enterprise panel for Customer Analytics.
// Thin 1px border, small radius, minimal shadow, compact header:
// [small icon] Title + subtitle … action. Dark-mode aware.
